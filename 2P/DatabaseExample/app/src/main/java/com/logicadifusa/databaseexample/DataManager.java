package com.logicadifusa.databaseexample;
...
public class DataManager {
    ...
    */
    ...
    public void insert(String name, String age){
        ...
        // INSERT INTO namesAndAge (name, age) VALUES ('Angel', '29');
    ...
    /*
    String query =
    "SELECT " + TABLE_ROW_PRODUCTNAME + "," + TABLE_ROW_CATEGORYNAME + "," + TABLE_ROW_UNITPRICE +
    " FROM " + TABLE_PRODUCTS +
    " INNER JOIN " + TABLE_CATEGORIES + " ON " + CATEGORY_ID + " = " + PRODUCT_CATEGORYID +
    " WHERE " + PRODUCT_UNIT_PRICE + " > " + unitPrice + ";"
     */
